...
class DataLibrus(app: App, profile: Profile?, loginStore: LoginStore) : Data(app, profile, loginStore) {
     ...
     * And also in various places in [eu.mikus.edziennik.api.v2.models.Feature]s
     */
     ...
     * Used when refreshing the [apiAccessToken] in JST, Synergia modes.
     * Used when refreshing the [apiAccessToken] in Portal mode ([eu.mikus.edziennik.api.v2.librus.login.SynergiaTokenExtractor])
     */
