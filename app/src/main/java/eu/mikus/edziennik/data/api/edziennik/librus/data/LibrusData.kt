...
package eu.mikus.edziennik.data.api.edziennik.librus.data

import eu.mikus.edziennik.R
import eu.mikus.edziennik.data.api.edziennik.librus.*
import eu.mikus.edziennik.data.api.edziennik.librus.data.api.*
import eu.mikus.edziennik.data.api.edziennik.librus.data.messages.LibrusMessagesGetList
import eu.mikus.edziennik.data.api.edziennik.librus.data.synergia.LibrusSynergiaGetMessages
import eu.mikus.edziennik.data.api.edziennik.librus.data.synergia.LibrusSynergiaHomework
import eu.mikus.edziennik.data.api.edziennik.librus.data.synergia.LibrusSynergiaInfo
