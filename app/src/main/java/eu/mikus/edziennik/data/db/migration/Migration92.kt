...
import eu.mikus.edziennik.data.db.entity.Event.Companion.COLOR_ELEARNING
import eu.mikus.edziennik.data.db.entity.Event.Companion.TYPE_ELEARNING
import eu.mikus.edziennik.data.db.entity.Event.Companion.TYPE_INFORMATION
import eu.mikus.edziennik.data.db.entity.EventType.Companion.SOURCE_DEFAULT
import eu.mikus.edziennik.data.db.entity.EventType.Companion.SOURCE_REGISTER
