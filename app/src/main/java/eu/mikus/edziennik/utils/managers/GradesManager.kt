...
import eu.mikus.edziennik.data.db.entity.Grade.Companion.TYPE_POINT_SUM
import eu.mikus.edziennik.data.db.entity.Grade.Companion.TYPE_YEAR_FINAL
import eu.mikus.edziennik.data.db.enums.SchoolType
...
import eu.mikus.edziennik.ext.ifNotNull
import eu.mikus.edziennik.ext.notEmptyOrNull
