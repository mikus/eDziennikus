...
import eu.mikus.edziennik.databinding.DialogConfigGradesBinding
import eu.mikus.edziennik.ext.join
import eu.mikus.edziennik.ext.onChange
import eu.mikus.edziennik.ext.onClick
import eu.mikus.edziennik.ext.setOnSelectedListener
...
import eu.mikus.edziennik.utils.managers.GradesManager.Companion.UNIVERSITY_AVERAGE_MODE_ECTS
import eu.mikus.edziennik.utils.managers.GradesManager.Companion.UNIVERSITY_AVERAGE_MODE_SIMPLE
