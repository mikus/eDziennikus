...
Java_eu_mikus_edziennik_data_api_szkolny_interceptor_Signing_iLoveApple(
        JNIEnv* nut,
        jobject guitar,
        jbyteArray school,
        jstring history,
    ...
    jclass partner = nut->FindClass("eu/mikus/edziennik/data/api/szkolny/interceptor/Signing");
